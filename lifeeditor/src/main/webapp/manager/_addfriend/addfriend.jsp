...
<script type="text/javascript">
 ...
 function getData() { //創建Session 所有 Data的Servlet
...
$(document ).ready(function() { 
	...
	$("#txtSearch").keyup(function() { //如果Keyup時
		...
		if(txt.value != "" & typeof(txt.value) == typeof("test")){ //如果不是空值，型態是String時
			$.ajax({
				  type:"POST",
				  dataType: 'json',
				  url: '/lifeeditor/com.lifeeditor.invite_list/getDatafromSession',
				  data: {'txt':txt.value},
...
function test(value){
	$.ajax({
		type:"POST",
		dataType:"text",
		url: '/lifeeditor/com.lifeeditor.invite_list/addFriend',
		data: {'id':value},	
		success: function (){
