...
<body>
	...
	<form ENCTYPE="multipart/form-data" method="POST"
		...
		<table border="0">
			...
			<tr>
				<td>活動名稱:</td>
				<td><input type="TEXT" name="updateEventName" size="45"
					value="<%=eventVO.getEventName()%>" /></td>
			</tr>
			<tr>
				<td>主辦單位名稱:</td>
				<td><input type="TEXT" name="updateOrgName" size="45"
					value="<%=eventVO.getOrgName()%>" /></td>
			</tr>
			<td>主辦單位地址:</td>
			<td><input type="TEXT" name="updateOrgAddr" size="45"
				value="<%=eventVO.getOrgAddr()%>" /></td>
			</tr>
			<tr>
				<td>活動日期:</td>
				<td bgcolor="#CCCCFF"><input type="date" name="updateEventTime"
					value="<%=eventVO.getEventTime()%>" class="form-control">

				</td>
			</tr>
			<tr>
				<td>圖片檔案:</td>
				<td><input type="file" name="updatefile" size="45"
					value="<%=eventVO.getEventPic()%>" /></td>
				<img height='100' width='80'
					src='/lifeeditor/eventPicServlet?id=<%=eventVO.getEventID()%>'>
				</td>
			</tr>
			<tr>
				<td>描述:</td>
		...
		<br> <input type="hidden" name="action" value="update"> <input
			type="hidden" name="eventID" value="<%=eventVO.getEventID()%>">
